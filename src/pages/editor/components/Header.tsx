...
export const Header = ({trackName, save, isLoading}: {trackName: String, save: () => void, isLoading: boolean}) => {
    return (
    ...
    <Button isLoading={isLoading} colorScheme='pink' rounded={"full"} w={24} onClick={save}>保存</Button>
    </Flex>
    )
}